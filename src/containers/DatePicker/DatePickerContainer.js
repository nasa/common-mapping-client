...
export class DatePickerContainer extends Component {
    ...
    render() {
        ...
        return (
            ...
            <KeyHandler keyEventName={KEYUP} keyCode={37} onKeyHandle={() => {this.incrementDate("days",true)}} />
                <KeyHandler keyEventName={KEYUP} keyCode={39} onKeyHandle={() => {this.incrementDate("days",false)}} />
