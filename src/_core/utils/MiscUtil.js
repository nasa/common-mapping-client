...
export default class MiscUtil {
    ...
    /**
     * LARGELY DUPLICATED FROM: https://github.com/reduxjs/redux/blob/master/src/bindActionCreators.js
     *
     ...
     * @memberof MiscUtil
     */
    static bindActionCreators(actionCreators, dispatch, opt_this = null) {
        if (typeof actionCreators === "function") {
            return this.bindActionCreator(actionCreators, dispatch, opt_this);
        }
        ...
        for (let i = 0; i < keys.length; i++) {
            ...
            if (typeof actionCreator === "function") {
                boundActionCreators[key] = this.bindActionCreator(
                    actionCreator,
                    dispatch,
                    opt_this
                );
    ...
    static bindActionCreator(actionCreator, dispatch, opt_this = null) {
        return function() {
            return dispatch(actionCreator.apply(opt_this || this, arguments));
        };
    }
}
