    ...
    render() {
        return (
            <div className="hidden">
                ...
                <KeyHandler keyEventName={KEYDOWN} keyValue="Meta" onKeyHandle={() => this.disableDateAutoIncrement()} />
                <KeyHandler keyEventName={KEYUP} keyValue="Meta" onKeyHandle={() => this.enableDateAutoIncrement()} />
